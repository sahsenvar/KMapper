...
```kotlin
implementation("io.github.sahsenvar:kmapper-converters-immutable:2.0.1") // PersistentList & co.
implementation("io.github.sahsenvar:kmapper-converters-arrow:2.0.1")     // NonEmptyList, Option
implementation("io.github.sahsenvar:kmapper-converters-datetime:2.0.1")  // java.time + bridges
