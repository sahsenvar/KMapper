...
mavenPublishing {
    ...
    pom {
        name.set("KMapper converters-bignumber")
        description.set(
            "KMP-friendly compile-time object mapper (KSP). Converters-bignumber module: ionspin BigDecimal/BigInteger (common) and java.math (jvm/android) scalar converters.",
        )
