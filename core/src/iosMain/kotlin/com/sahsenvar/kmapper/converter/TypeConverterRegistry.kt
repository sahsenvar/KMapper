...
actual object TypeConverterRegistry {
    ...
    private fun key(s: KClass<*>, t: KClass<*>) =
    ...
    actual fun <S : Any, T : Any> get(sourceType: KClass<S>, targetType: KClass<T>): MapTypeConverter<S, T>? =
        map[key(sourceType, targetType)] as? MapTypeConverter<S, T>

    actual fun <S : Any, T : Any> has(sourceType: KClass<S>, targetType: KClass<T>): Boolean =
